...
func TestSolveDay6Part1Pre(t *testing.T) {
	assert.Equal(t, 1_000_000, SolveDay6Part1("turn on 0,0 through 999,999"))
	assert.Equal(t, 1000, SolveDay6Part1("toggle 0,0 through 999,0"))
	assert.Equal(t, 0, SolveDay6Part1("turn off 499,499 through 500,500"))
}

func TestSolveDay6Part2Pre(t *testing.T) {
	assert.Equal(t, 1, SolveDay6Part2("turn on 0,0 through 0,0"))
	assert.Equal(t, 2_000_000, SolveDay6Part2("toggle 0,0 through 999,999"))
}

func TestSolveDay6Part1Final(t *testing.T) {
...
toggle 628,958 through 811,992`
	fmt.Println(SolveDay6Part1(input))
}

func TestSolveDay6Part2Final(t *testing.T) {
	input := `turn on 489,959 through 759,964
turn off 820,516 through 871,914
turn off 427,423 through 929,502
turn on 774,14 through 977,877
...
turn on 31,760 through 655,892
toggle 628,958 through 811,992`
	fmt.Println(SolveDay6Part2(input))
}
